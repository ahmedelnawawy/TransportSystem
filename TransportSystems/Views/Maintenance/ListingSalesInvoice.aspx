<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListingSalesInvoice.aspx.cs" Inherits="TransportSystems.Views.Maintenance.ListingSalesInvoice" %>
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                 <h2 class="kt-portlet__head-title" style="color: orangered; font-family: 'Times New Roman', Times, serif; font-size: large">  
                     <%=Resources.Store.SaleInvoice %>
                </h2>
            </div>
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-actions">
                    <a class="btn btn-default btn-pill btn-sm btn-icon btn-icon-md custom-sm" title="Add" href="../Maintenance/OperSalesInvoice.aspx"> 
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    <label class="mr-5" style="font-family: 'Times New Roman', Times, serif; font-size: larger; display: inline">
                        <%=Resources.Store.Cars %>
                    </label>
                    <asp:DropDownList ID="CarsListtxt" runat="server"
                ...
                <div class="form-group col-md-3" style="border:1px #dddddd solid;border-radius: 25px;">
                    ...
                    <div class="custom-control custom-radio mr-2" style="display: inline-block">
                        <asp:RadioButton ID="Sale" GroupName="PurchaseType" runat="server" Checked="False" />
                        <label style="display: inline; font-family: 'Times New Roman', Times, serif; font-size: larger" for="VoidedState"><%=Resources.Store.Sale %></label>
                    </div>
                    <div class="custom-control custom-radio mr-2" style="display: inline-block">
