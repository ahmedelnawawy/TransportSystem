<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OperSalesInvoice.aspx.cs" Inherits="TransportSystems.Views.Maintenance.OperSalesInvoice" %>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3" style="border:1px #dddddd solid;border-radius: 25px;">
                     ...
                     <div class="custom-control custom-radio mr-2" style="display: inline-block">
                         <asp:RadioButton ID="Sale" GroupName="PurchaseType" runat="server" Checked="true" />
                ...
                <div class="form-group col-md-3">
                    <label class="mr-5" style="font-family: 'Times New Roman', Times, serif; font-size: larger; display: inline">
                        <%=Resources.Store.ServiceName %>
                    </label>
                    <asp:DropDownList ID="ServicesListtxt" runat="server"
                        CssClass="browser-default custom-select form-control" Width="100%">
                    </asp:DropDownList>
                </div>
            </div>
