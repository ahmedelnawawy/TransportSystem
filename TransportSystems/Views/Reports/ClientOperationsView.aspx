<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientOperationsView.aspx.cs" Inherits="TransportSystems.Views.Reports.ClientOperationsView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div  id="prtg" class="kt-portlet mb-0">
             ...
             <h1 style="text-align:center;color:red;"><u>كشف حساب عميل</u></h1>
