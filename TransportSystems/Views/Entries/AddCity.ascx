<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddCity.ascx.cs" Inherits="TransportSystems.Views.Entries.AddCity" %>
<div class="input-group">
    <asp:DropDownList ID="CityListhtml" runat="server" CssClass="browser-default custom-select" Width="100%">
    </asp:DropDownList>
    <div id="divmodal" runat="server" class="input-group-append" data-target="#CityModal" data-toggle="modal">
...
<div class="modal text-center" id="CityModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4><%=Resources.Store.AddCity%> </h4>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="modal-body">
                        <div>
                            <div style="width: 100%">
                                <asp:HiddenField ID="CityIdHid" runat="server" Value="0" />
                                <div class="form-group" style="width: 49%; display: inline-block;">
                                    ...
                                    <asp:TextBox ID="City_Name" runat="server" CssClass="form-control col-md-12" placeholder="<%$Resources:Store,NamePH%>"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="City_Name"
