<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddSector.ascx.cs" Inherits="TransportSystems.Views.Entries.AddSector" %>
<div class="input-group">
    <asp:DropDownList ID="DropMatList" runat="server" CssClass="browser-default custom-select" Width="100%">
    </asp:DropDownList>
    <div id="divmodal" runat="server" class="input-group-append" data-target="#CategModal" data-toggle="modal">
...
<div class="modal fade" id="CategModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4><%=Resources.Store.AddCategory%> </h4>
                        ...
                        <div>
                            <div style="width: 100%">
                                ...
                                <div class="form-group" style="width: 100%; display: inline-block;">
                                    ...
                                    <asp:TextBox ID="Cat_Name" runat="server" CssClass="form-control col-md-12" placeholder="<%$Resources:Store,NamePH%>" ValidationGroup="CatGrou"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Cat_Name" ValidationGroup="CatGrou"
                                        CssClass="alert-danger" ErrorMessage="<%$Resources:Store,NameEM%>">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="text-center">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="alert-danger" DisplayMode="List" ValidationGroup="CatGrou" />
                                <br />
                                <asp:Button  ID="Save_Cat" runat="server" AutoPostBack="true" Text="<%$Resources:Store,Save%>" CssClass="btn btn-success" OnClick="Save_Cat_Click" />
                            ...
                            <div class="table-responsive mt-3">
                                <asp:GridView ID="GridView1" AllowPaging="true" PageSize="10" OnPageIndexChanging="GridView1_PageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Name" HeaderText="<%$Resources:Store,CategoryName%>" />
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="edit_Btn" runat="server"  CssClass="grid-tool"  CausesValidation="False"
                                                    CommandArgument="<%# Container.DataItemIndex %>" OnCommand="edit_Command" >
