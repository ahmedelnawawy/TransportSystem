<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddTrafficDepartment.ascx.cs" Inherits="TransportSystems.Views.Entries.AddTrafficDepartment" %>
<div class="input-group">
    <asp:DropDownList ID="TrafficDepartmentListhtml" runat="server" CssClass="browser-default custom-select" Width="100%">
    </asp:DropDownList>
    <div id="divmodal" runat="server" class="input-group-append" data-target="#TrafficDepartmentModal" data-toggle="modal">
...
<div class="modal text-center" id="TrafficDepartmentModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4><%=Resources.Store.TrafficDepartment%> </h4>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="modal-body">
                        <div>
                            <div style="width: 100%">
                                <asp:HiddenField ID="TrafficDepartmentIdHid" runat="server" Value="0" />
                                <div class="form-group" style="width: 49%; display: inline-block;">
                                    ...
                                    <asp:TextBox ID="TrafficDepartment_Name" runat="server" CssClass="form-control col-md-12" placeholder="<%$Resources:Store,NamePH%>"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TrafficDepartment_Name"
