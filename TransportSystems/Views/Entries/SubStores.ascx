<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubStores.ascx.cs" Inherits="TransportSystems.Views.Entries.SubStores" %>
<div class="input-group">
    <asp:DropDownList ID="SubStoreListhtml" runat="server" CssClass="browser-default custom-select" Width="100%">
    </asp:DropDownList>
    <div id="divmodal" runat="server" class="input-group-append" data-target="#StoreModal" data-toggle="modal">
...
<div class="modal text-center" id="StoreModal"  tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4><%=Resources.Store.AddStore%> </h4>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                <ContentTemplate>
                    <div class="modal-body">
                        <div>
                            <div style="width: 100%">
                                <asp:HiddenField ID="StoreIdHid" runat="server" Value="0" />
                                <div class="form-group" style="width: 49%; display: inline-block;">
                                    ...
                                    <asp:TextBox ID="Store_Name" runat="server" CssClass="form-control col-md-12" placeholder="<%$Resources:Store,NamePH%>"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Store_Name"
                            ...
                            <div class="text-center">
                                ...
                                <br />
                                <asp:Button ID="Save_Store" runat="server" Text="<%$Resources:Store,Save%>" CssClass="btn btn-success" OnClick="Save_Store_Click" />
