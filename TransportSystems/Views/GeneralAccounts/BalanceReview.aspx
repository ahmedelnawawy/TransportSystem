<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BalanceReview.aspx.cs" Inherits="TransportSystems.Views.GeneralAccounts.BalanceReview" %>
...
اجمالى ارصدة مدينة                    
                          ...
                          <asp:Label ID="Label2"
                class="mr-3" style="font-family: 'Times New Roman', Times, serif; font-size: large; display: inline" runat="server" Text="0"></asp:Label>
          <asp:Label ID="Label3" runat="server" Text="اجمالى أرصدة دائنة"></asp:Label>
               <asp:Label ID="Label4" runat="server" Text="0"></asp:Label>
                  ...
                  <div class="row">
                      <div  class="form-group col-md-12">
  <asp:Label ID="Label5"  class="mr-3" style="font-family: 'Times New Roman', Times, serif; font-size: large; display: inline" runat="server" Text="الفرق"></asp:Label>
           
<asp:Label ID="Label6"  class="mr-3" style="font-family: 'Times New Roman', Times, serif; font-size: large; display: inline" runat="server" Text="0"></asp:Label>
                      </div>
                  </div>
              </div>
