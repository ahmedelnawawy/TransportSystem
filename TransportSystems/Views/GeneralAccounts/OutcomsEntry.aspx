<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OutcomsEntry.aspx.cs" Inherits="TransportSystems.Views.GeneralAccounts.OutcomsEntry" %>
...
حساب                    </label>
     ...
     BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal"
                               AutoGenerateColumns="False"  CssClass="table table-striped table-sm mb-0 text-center" 
                              OnRowDataBound="EntryGrdV_RowDataBound">
