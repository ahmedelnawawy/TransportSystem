<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OstazAccount.aspx.cs" Inherits="TransportSystems.Views.GeneralAccounts.OstazAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div  id="prtg" class="kt-portlet mb-0"  dir="rtl">
             ...
             <h1 style="text-align:center;color:red;"><u>كشف حساب استاذ</u></h1>
...
حساب                    </label>
     ...
     BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" 
                              CellPadding="4" GridLines="Horizontal"  CssClass="table table-striped table-sm mb-0 text-center"
